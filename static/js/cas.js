...
function resourceLoadedSuccessfully() {
    $(document).ready(function() {
        ...
        // UoM Customisations
        $( "#support_information" ).accordion();

	// Attract attention to the AUP without being too irritating (unless message on screen)
	if ($("#msg").length < 1) {
	    $("#aup_block").delay(1000).css("visibility","visible").hide().effect('slide',{}, 'slow');
	}

	// Rest is now CAS defaults, I think
